...
<head>
    ...
    <script src="https://kit.fontawesome.com/ce209d59ce.js" crossorigin="anonymous"></script>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="text-center">
                                        <h3>Mulai Diagnosa Kerusakan Pada Laptop</h3>
                                    </div>
                                    <img src="<?= base_url('assets/img/home.jpg'); ?>" class="card-img-top" alt="...">
                                    <br></br>
                                    <div class="d-flex justify-content-center">
                                        <a href="<?= base_url('diagnosa'); ?>" class="btn btn-primary btn-icon-split">
                                            ...
                                            <span class="text">Mulai Diagnosa</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
